// src/pages/Students/Announcement.jsx
...
const AnnouncementSection = () => {
  ...
  const fetchAnnouncements = async () => {
    try {
      ...
      setError('Could not load campus announcements');
      setAnnouncements([]);
    } finally {
      setLoading(false);
    }
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            ...
            <div>
              <Title level={4} style={{ margin: 0, color: '#0b1b3d', fontWeight: 800 }}>
                Campus Announcements & Schedules
              </Title>
              <Text style={{ color: '#64748b', fontSize: 13 }}>
                Access live timetables, general campus circulars, cohort notices, and personal announcements
              </Text>
            </div>
          </div>
      ...
      <Row gutter={[20, 20]} style={{ marginBottom: 28 }}>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 12 }}>
              <div>
                ...
                <Title level={4} style={{ margin: '4px 0 0 0', color: '#0b1b3d', fontWeight: 800 }}>
                  Class Timetable
                </Title>
              </div>
            ...
            <Text style={{ color: '#64748b', fontSize: 12, display: 'block', marginBottom: 16 }}>
              View weekly subject slots & room allocations
            </Text>
            <TimetableModal />
          </Card>
        </Col>

        {/* General Announcements Card */}
        <Col xs={24} sm={12} lg={6}>
          <Card 
            hoverable 
            className="apex-card apex-card-gold-header"
          ...
          >
            ...
            <Text style={{ color: '#64748b', fontSize: 12, display: 'block', marginBottom: 16 }}>
              Campus-wide institutional announcements
            </Text>
            <Button 
              type="primary" 
              block 
        ...
        <Col xs={24} sm={12} lg={6}>
          ...
          >
            ...
            <Text style={{ color: '#64748b', fontSize: 12, display: 'block', marginBottom: 16 }}>
              Notices released for all enrolled students
            </Text>
            <Button 
              type="primary" 
              block 
            ...
            >
              View Student Notices <ArrowRightOutlined />
            </Button>
          </Card>
        </Col>

        {/* Personal Announcements Card */}
        <Col xs={24} sm={12} lg={6}>
          <Card 
            hoverable 
            className="apex-card apex-card-gold-header"
          ...
          >
            ...
            <Text style={{ color: '#64748b', fontSize: 12, display: 'block', marginBottom: 16 }}>
              Targeted messages and advisories for you
            </Text>
            <Button 
              type="primary" 
              block 
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '4px 0' }}>
            ...
            <div>
              <Title level={5} style={{ margin: 0, color: '#0b1b3d', fontWeight: 700 }}>
                Recent Campus Announcements Feed
              </Title>
              <Text style={{ color: '#64748b', fontSize: 11 }}>Official stream of announcements and advisories</Text>
            </div>
          </div>
        }
      >
